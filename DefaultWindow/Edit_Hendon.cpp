...
void CEdit_Hendon::Initialize()
{
}

int CEdit_Hendon::Update()
{
	Key_Input();
...
void CEdit_Hendon::Late_Update()
{
	CTileMgr::Get_Instance()->Late_Update();
}

void CEdit_Hendon::Render(HDC hDC)
{
...
void CEdit_Hendon::Release()
{
}

void CEdit_Hendon::Key_Input()
{
	...
	if (CKeyMgr::Get_Instance()->Key_Down('S'))
		CTileMgr::Get_Instance()->Save_Tile(L"../Image/Tile/Hendon_Tile.dat");
