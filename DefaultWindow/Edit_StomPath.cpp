...
void CEdit_StomPath::Initialize()
{
}

int CEdit_StomPath::Update()
{
	Key_Input();
...
void CEdit_StomPath::Late_Update()
{
	CTileMgr::Get_Instance()->Late_Update();
}

void CEdit_StomPath::Render(HDC hDC)
{
...
void CEdit_StomPath::Release()
{
}

void CEdit_StomPath::Key_Input()
{
