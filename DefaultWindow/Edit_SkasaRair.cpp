...
CEdit_SkasaRair::CEdit_SkasaRair()
{
}
...
void CEdit_SkasaRair::Initialize()
{
}

int CEdit_SkasaRair::Update()
{
	Key_Input();
...
void CEdit_SkasaRair::Late_Update()
{
	CTileMgr::Get_Instance()->Late_Update();
}

void CEdit_SkasaRair::Render(HDC hDC)
{
...
void CEdit_SkasaRair::Release()
{
}

void CEdit_SkasaRair::Key_Input()
{
	...
	if (CKeyMgr::Get_Instance()->Key_Down('S'))
		CTileMgr::Get_Instance()->Save_Tile(L"../Image/Tile/SkasaRair_Tile.dat");
