...
void CEdit_Nest::Initialize()
{
}

int CEdit_Nest::Update()
{
	Key_Input();
...
void CEdit_Nest::Late_Update()
{
	CTileMgr::Get_Instance()->Late_Update();
}

void CEdit_Nest::Render(HDC hDC)
{
...
void CEdit_Nest::Release()
{
}

void CEdit_Nest::Key_Input()
{
	...
	if (CKeyMgr::Get_Instance()->Key_Down('S'))
		CTileMgr::Get_Instance()->Save_Tile(L"../Image/Tile/Nest_Tile.dat");
